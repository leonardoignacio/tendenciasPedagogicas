        ...
        <div class="bg-white rounded-xl shadow-sm p-6 lg:p-8 border-t-4 border-brand-blue card-hover">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-4">
                ...
                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 shadow-sm relative">
                    ...
                    <p class="text-base text-gray-600 mb-4"><strong>Materialize os<br> sentimentos | pensamentos | inquietações em ARTE</strong>, produza uma <strong>representação gráfica</strong> sobre o tema, que irá compor o <strong>Mural de Tendências Pedagógicas Brasileiras!</strong></p>
